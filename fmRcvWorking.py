...
class fmrcv1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fmrcv2")
        ...
        self.uhd_usrp_source_0.set_center_freq(90.9e6, 0)
    ...
    def closeEvent(self, event):
        self.settings = Qt.QSettings("GNU Radio", "fmrcv1")
...
def main(top_block_cls=fmrcv1, options=None):
